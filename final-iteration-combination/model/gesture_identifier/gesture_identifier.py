...
class GestureIdentifier(object):
    def __init__(
        self,
        model_path='model/gesture_identifier/gesture_identifier.tflite',
        num_threads=1,
    ):
    ...
    def predict_confidence(self, landmark_list):
        ...
        return np.squeeze(result)  # returns an array of confidences for all gestures
